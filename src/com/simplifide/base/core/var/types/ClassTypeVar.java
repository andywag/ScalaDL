...
public class ClassTypeVar<T extends SystemVar> extends TypeVar<T>
{
    ...
    public static ClassTypeVar<SystemVar> createVar(ReferenceItem<? extends InstanceModule> ref) {
        ReferenceItem<ClassInstanceModule> mod = ((ClassInstanceModule)ref.getObject()).createReferenceItem();
        return new ClassTypeVar<SystemVar>(mod);
    }
