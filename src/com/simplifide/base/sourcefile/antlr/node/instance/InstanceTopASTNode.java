...
public class InstanceTopASTNode extends TopASTNode
{
    ...
    protected void attachConnectorModule(ReferenceItem<? extends EntityHolder> entityRef,
            ReferenceItem<? extends HardwareModule> moduleRef,
        ...
        if (entityRef != null) {
            ...
            ReferenceItem<? extends InstanceModule> childModRef = entityRef.getObject().getInstanceModRef();
