...
public abstract class ConnectionStore {
	...
	public IOList handleAutoArgs(TemplateContents cont, ParseContext context) {
	...
	public static IOList handleAutoInstance(TemplateContents cont, ParseContext context) {
