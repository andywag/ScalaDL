...
object FirTest {
    ...
    /** Simple Project which only contains an FIR filter */
  object FirProject extends Project {
    // Location where the project outputs are going to be stored
    val location:String = TestConstants.locationPrefix + "outputs" + TestConstants.separator + "fir"
