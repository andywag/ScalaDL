...
public class DelegateVar extends SystemVar{
    ...
    private ReferenceItem<? extends SystemVar> baseVar;
	...
	public void setBaseVar(ReferenceItem<? extends SystemVar> baseVar) {
		this.baseVar = baseVar;
	}

	public ReferenceItem<? extends SystemVar> getBaseVar() {
		return baseVar;
	}
