...
object ObjectFactory {
  ...
  def Mult(lhs:Expression,rhs:Expression)(implicit clk:ClockControl):SimpleSegment =
    Mult(lhs,rhs,Model.NoFixed,Model.NoFixed)(clk)
  // Multiplier
  def Mult(lhs:Expression,rhs:Expression,fixed:Model.Fixed,internal:Model.Fixed)(implicit clk:ClockControl):SimpleSegment = {
    (lhs,rhs) match {
