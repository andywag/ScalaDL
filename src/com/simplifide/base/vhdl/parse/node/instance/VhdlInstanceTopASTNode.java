...
public class VhdlInstanceTopASTNode extends InstanceTopASTNode {
    ...
    public void resolveContext(ParseContext context) {
        ...
        ReferenceItem<? extends EntityHolder> holdRef = this.findEntityRef(child, context);
    ...
    private ReferenceItem<? extends EntityHolder> getEntityFromProject(ReferenceItem projR, String[] us) {
    	ReferenceItem<? extends EntityHolder> holderRef = null;
    ...
    private ReferenceItem<? extends EntityHolder> getEntityFromOtherProject(CoreProjectSuite suite, String[] us) {
    	ReferenceItem<? extends EntityHolder> holderRef = null;
    ...
    private ReferenceItem<? extends EntityHolder> findEntityRef(TopASTNode ch, ParseContext context) {
    ...
    private TopObjectBase generateModuleNormal(ParseContext context) {
        ...
        ReferenceItem<? extends HardwareModule> moduleRef = context.getRefHandler().getModuleReference();
        
        // Finds either the component or entity associated with this instance
        ReferenceItem<? extends EntityHolder> entityRef = this.findEntityRef(ch, context);
