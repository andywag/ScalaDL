...
import com.simplifide.generate.parser.{SignalParser, ConditionParser, SegmentHolder}
...
trait ComplexSegment extends ConditionParser with SignalParser with SimpleSegment{
