...
public class ClassBodyNode extends TopASTNodeGeneric<ReferenceItem<HardwareModule>>{
	...
	public static class ClassBodyListNode extends TopBodyNode{
		...
		public ReferenceItem<? extends HardwareModule> generateModuleSmallNew(ParseContext context) {
			
			ReferenceItem<? extends HardwareModule> moduleR = context.getRefHandler().getModuleReference();
