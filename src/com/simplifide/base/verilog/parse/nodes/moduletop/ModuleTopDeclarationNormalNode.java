...
public abstract class ModuleTopDeclarationNormalNode extends TopASTNodeGeneric<ReferenceItem<Entity>>{
	...
	public ReferenceItem<Entity> createObjectSmall(ParseContext context) {
    	...
    	// Instance Creation or Finding from ProjectGenerator
        ...
        if (imodR == null) {
            ...
            // Add Instance Module to ProjectGenerator
        ...
        // Module Handling
    	ReferenceItem<HardwareModule> modR = (ReferenceItem<HardwareModule>) bodyNode.generateModule(context);
