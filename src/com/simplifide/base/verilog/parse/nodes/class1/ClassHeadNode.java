...
public class ClassHeadNode extends TopASTNodeGeneric<ReferenceItem<ClassEntity>>{
	...
	public ReferenceItem<ClassEntity> createObjectSmall(ParseContext context) {
		...
		ReferenceItem<? extends InstanceModule> superR = (ReferenceItem<? extends InstanceModule>) extendsNode.generateModule(context);
        ...
        ReferenceItem<ClassInstanceModule> instR =  ((ClassInstanceModule)superR.getObject()).createReferenceItem();
		nclass.setSuperR(instR);
