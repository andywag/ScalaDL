...
public class ModInstanceConnect extends ModInstanceTop<PortTop> implements java.io.Serializable {
    ...
    private ReferenceItem<? extends EntityHolder> entityRef;
    ...
    public ModInstanceConnect(String instanceName, ReferenceItem<? extends EntityHolder> connect) {
        super(instanceName);
    ...
    public List<PortTop> getPorts() {
        return this.getPortListRef().getObject().getPorts();
    }

    public List<PortTop> getParameters() {
        return this.getGenericListRef().getObject().getPorts();
    }
    ...
    public ReferenceItem<? extends EntityHolder> getEntityRef() {
        return entityRef;
    }

    public void setEntityRef(ReferenceItem<? extends EntityHolder> entityRef) {
